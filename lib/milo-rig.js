...
export const MILO_PARTS = {
  ...
  "arm-left": { x: 121, y: 293, w: 92, h: 96, size: [180, 188] },
  "arm-right": { x: 291, y: 293, w: 92, h: 96, size: [180, 188] },
  wave: { x: 107, y: 237, w: 104, h: 107, size: [200, 205] },
  think: { x: 211, y: 265, w: 79, h: 89, size: [180, 203] },
};

export const MILO_PART_NAMES = Object.keys(MILO_PARTS);
...
export function partPlacement(name) {
